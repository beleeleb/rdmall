...
public:
  ...
  LegendaryAnimal(const LegendaryAnimal& o_): Animal(o_), m_a1(new Centipede(static_cast<Centipede&>(*o_.m_a1))),
  		  m_a2(new Squirl(static_cast<Squirl&>(*o_.m_a2))),m_c(o_.m_c),m_sq(o_.m_sq)
    {}
